...
g++ push_test.cpp func.cpp lift.cpp min.cpp preflow.cpp approve_push.cpp -I/usr/local/include/igraph -ligraph -o push_relabel 
...
do
 # count=0;
  ...
  do
    ...
    ./push_relabel node_$i/read_graph_edge_$i.txt node_$i/read_graph_weight_$i.txt output_file.txt $j $k node_$i/sampleTr-0.txt
